...
public class ProductController {
	...
	private double calculateTotalInventoryAmount() {
		...
		//return 123456.78;
		double totalInventoryAmount = 0.0; //initialisation
		for (Product p : productService.products()) { // Loop Use productService
			totalInventoryAmount =p.getInventoryPrice() + totalInventoryAmount ; // incrementation
		}
